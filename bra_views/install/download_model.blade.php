...
@section('main')
    ...
    <div class="install-box">
        ...
        <div class="step-btns">
            ...
            <button type="submit" onclick="check_status()" class="layui-btn layui-btn-big layui-btn-normal fr"
                    lay-submit="" lay-filter="formSubmit">下一步
            </button>
        </div>
    </div>
...
@section('footer_js')
    <script>
        var next_step_url = "/install/index/finish";
        var tables = @json($sys_tables);
        var total = tables.length;
        var install_model_api = "/install/index/download_model";
        ...
        function check_status() {
            if (tables.length === 0) {
                $.get("/install/index/finished" , function (data) {
                    console.log(data)

...
<div class="columns is-mobile is-vcentered is-gapless is-centered" style="width:100vw;height:90vh;">
    ...
    <div class="column is-narrow bra-dialog is-radius-large is-clipped is-box is-success" style="min-width:300px;border-radius:6px">
        <div class="bra-dialog-header" style="font-size: 12px">提示信息</div>

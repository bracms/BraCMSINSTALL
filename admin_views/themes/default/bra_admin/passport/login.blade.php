...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset("statics/packs/braui/themes/admin/$season.css") }}" >
    <style>
...
<div class="login-container" id="bracms_app">
    ...
    <div class="right_box">
        ...
        <form id="login_form" class="bra-form" :class="{'is-loading' : is_loading}" bra-id="login_form">
            ...
            {!!  \Bra\core\http\BraCsrfMiddleware::csrf_token_form() !!}
...
<script type="text/javascript" src="{{ asset("statics/packs/braui/themes/admin/$season.js") }}"></script>
<script>

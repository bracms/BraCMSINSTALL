...
@section('main')
    ...
    <div class="install-box">
        ...
        <table class="layui-table">
            ...
            <tr>
                <td>温馨提示:</td>
                <td><span id="">如果下载过程中卡住,请修改mysql配置文件,将sql-mode配置为:  sql-mode=NO_ENGINE_SUBSTITUTION</span>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    <div>
                        ...
                        <progress style="width:100%" class="progress is-size-1 is-danger" id="file_process" value="0"
                                  max="{{count($sys_tables)}}">1
                        </progress>
                    </div>
                </td>
            </tr>
        ...
        <div class="step-btns">
            ...
            <button type="submit" onclick="check_status()" class="layui-btn layui-btn-big layui-btn-normal fr">下一步
            </button>
        </div>
    </div>
...
@section('footer_js')
    <script>
        var next_step_url = "/bra_admin/admin_update/index?act=finished&module={{$module}}&menu_id=34";
        var tables = @json($sys_tables);
        var total = tables.length;
        var install_model_api = "/bra_admin/admin_update/index?act=download_models&module={{$module}}&menu_id=34";

        function install_tables() {

            require(['layer', 'jquery'], function (layer, $) {
                $("#" + tables[0] + "_status").html("正在安装");
                $.post(install_model_api, {

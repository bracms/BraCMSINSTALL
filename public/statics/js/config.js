(function (require, define) {
    var path_obj = {
        ...
        paths: {
            ...
            'bra_picker': '../packs/braui/bra_picker',
            ...
            "pixi-filters": "https://cdn.jsdelivr.net/npm/pixi-filters@4.1.6/dist/pixi-filters",
            "layer": "../packs/layer/layer",
            "flow" : "../packs/flowjs/flow",
            "sha1" : "../packs/crypto/sha1",
            "cryptojs" : "https://cdnjs.cloudflare.com/ajax/libs/crypto-js/3.1.9-1/crypto-js",
            "mobile_select" : "../packs/mobileSelect/mobile_select"
        },
        shim: {
            ...
            'mobile_select' : {
                deps : ["css!../packs/mobileSelect/mobile_select.css"] ,
